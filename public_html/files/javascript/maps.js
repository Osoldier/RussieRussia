...
var GroundMap = [
    ...
    new room(LONGER, [new object(300, 200, 16, 16, false, DRAPCOM, null)], [new door(LEFT, 4, 3, null, false), new door(RIGHT, 5, 6, null, false)]),
    new room(LONGER, [new object(700, 400, 32, 32, true, PUIT, "B")], [new door(LEFT, 6, 5, null, false), new door(RIGHT, 7, 8, null, false)]),
    new room(LONGER, [new object(220, 550, 16, 16, false, TANK, null)], [new door(LEFT, 8, 7, null, false), new door(RIGHT, 9, 10, "red", true)]),
    new room(SQUARED, [new object(950, 500, 16, 16, false, DRAPCOM, null)], [new door(LEFT, 10, 9, "red", true), new door(BOTTOM, 11, 12, "green", true)]),
