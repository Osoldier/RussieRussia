...
var GroundMap = [
    ...
    /* 98 */ new room(SQUARED,[new object(300,500,32,32,true,CAVIAR),new object(600,500,32,32,true,CIGARETTE),new door(450,700,32,32,true,DRAPCOM)],[new door(LEFT,249,248,null,false)]),
    /* 99 */ new room(SQUARED,[new object(500,500,64,64,false,PEAUOURS,"A"),new door(500,650,32,32,true,VODKA)],[new door(RIGHT,250,251,null,false)]),
