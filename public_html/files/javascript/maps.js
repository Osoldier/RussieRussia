...
var GroundMap = [
    ...
    /* 5 */ new room(SQUARED, [new object(950, 500, 64, 64, false, TANK, null)], [new door(LEFT, 10, 9, RED, true), new door(BOTTOM, 11, 12, GREEN, true)]),
    ...
    /* 15 */ new room(SQUARED, [new object(600, 800, 40, 30, false, DRAPCOM, null), new object(400, 200, 30, 50, true, CIGARETTE)], [new door(RIGHT, 31, 30, null, false), new door(LEFT, 32, 33, null, false)]),
    ...
    /* 20 */ new room(SQUARED, [new object(600, 250, 64, 64, false, PEAUOURS, "G"), new object(600, 35, 64, 64, false, LIVRE, null), new object(600, 500, 32, 32, true, CIGARETTE, null)], [new door(LEFT, 48, 49, null, false), new door(RIGHT, 47, 46, null, false)]),
    ...
    /* 103 */ new room(SQUARED,[new object(700,700,32,32,true,CAVIAR),new object(980,450,32,32,false,DRAPCOM)],[new door(LEFT,259,258,null,false),new door(BOTTOM,260,269,null,false)]),
    ...
    /* 108 */ new room(SQUARED,[new object(600,450,64,64,false,PEAUOURS,"D"),new object(200,800,32,32,true,VODKA),new object(600,800,32,32,false,DRAPCOM)],[new door(TOP,269,260,null,false),new door(RIGHT,270,271,null,false)]),
    ...
    /* 118 */ new room(LARGER,[new object(600,810,64,64,false,LIVRE)],[new door(TOP,292,275,null,false)]),
    ...
    /* 122 */ new room(SQUARED,[new object(600,140,32,32,true,CIGARETTE),new object(600,30,64,64,false,DRAPCOM)],[new door(LEFT,301,300,RED,true)]), 
    ...
    /* 126 */ new room(SQUARED,[new object(600,30,64,64,false,DRAPCOM)],[new door(LEFT,309,308,null,false),new door(RIGHT,311,312,GREEN,true),new door(BOTTOM,310,319,null,false)]),
    ...
    /* 132 */ new room(SQUARED,[new object(600,30,64,64,false,LIVRE)],[new door(LEFT,325,324,null,false),new door(RIGHT,327,328,BLUE,true),new door(BOTTOM,326,340,null,false)]),
    ...
    /* 135 */ new room(SQUARED,[new object(500,500,32,32,true,VODKA),new object(750,500,32,32,true,CIGARETTE),new object(600,810,64,64,false,LIVRE)],[new door(LEFT,334,333,null,false)]), 
    /* 136 */ new room(SQUARED,[new object(600,250,32,32,true,CAVIAR),new object(600,450,32,32,true,CIGARETTE),new object(600,650,32,32,true,VODKA),new object(915,450,64,64,false,TANK)],[new door(TOP,335,318,null,false),new door(BOTTOM,336,75,null,false)]),
    ...
    /* 138 */ new room(SQUARED,[new object(400,650,32,32,true,VODKA),new object(980,450,64,64,false,LIVRE)],[new door(TOP,340,326,null,false),new door(LEFT,339,338,null,false)]),
    /* 139 */ new room(SQUARED,[new object(270,400,64,64,false,TANK)],[new door(TOP,341,332,null,false)]),
];
